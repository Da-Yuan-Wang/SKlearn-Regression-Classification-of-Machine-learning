...
sns.scatterplot(x=y_test, y=y_predict_test, color="purple", s=60, edgecolor="black")
...
# 特征重要性:在机器学习中，分类和回归算法的 feature_importances_属性用于衡量每个特征对模型预测的重要性。
# 通过 feature importances 属性，您可以了解哪些特征对模型的预测最为重要，从而可以进行特征选择或特征工程，以提高模型的性能和解释性。
# 这个.feature_importances_属性通常在基于树的算法中使用，决策树、随机森林、梯度提升树等机器学习算法。
